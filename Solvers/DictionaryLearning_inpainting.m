function [D,A,cost] = DictionaryLearning_inpainting(Y,reliable_samples_mat,paramDL)
% Perform declipping using dictionary learning for inpainting
% 
% Inputs:
...
while it < paramDL.Nit
    ...
    [A,cost_SC] = IHT_inpainting(Y,reliable_samples_mat,D,paramSC);
