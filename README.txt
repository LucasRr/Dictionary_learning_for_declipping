...
- IHT_inpainting.m discards the clipped samples and performs sparse decomposition on the unclipped samples, using IHT and a fixed DCT dictionary
- DictionaryLearning_inpainting.m discards the clipped samples and performs a gradient descent-based dictionary learning on the unclipped samples
- consIHT.m performs consistent IHT for declipping, using a fixed DCT dictionary [1]
- consDictionaryLearning.m performs consistent dictionary learning for signal declipping, as proposed in [2]
...
This code has been implemented and tested using MATLAB R2017a.
